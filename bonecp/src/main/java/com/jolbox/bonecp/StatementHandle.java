...
public class StatementHandle implements Statement {
    ...
    public StatementHandle(Statement internalStatement, String sql, IStatementCache cache,
        ...
        try {
            this.queryExecuteTimeLimit =
                    connectionHandle.getOriginatingPartition().getQueryExecuteTimeLimitinNanoSeconds();
        }
    ...
    protected long queryTimerStart() {
        return this.statisticsEnabled || ((this.queryExecuteTimeLimit != 0) && (this.connectionHook != null)) ? System
